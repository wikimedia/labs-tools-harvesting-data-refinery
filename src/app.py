...
def index():
	...
	if username is not None:
		if blocked()['blockstatus']:
			...
			return flask.render_template('tool.html', logged=logged(), username=getusername(), user=request.args.get('username', ''), property=request.args.get('property', ''), limit=request.args.get('limit', '10'))
	else:
